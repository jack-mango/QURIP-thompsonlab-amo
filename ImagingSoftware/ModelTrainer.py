...
class ModelTrainer():
    ...
    def __init__(self, model, training, testing, fidelity, n_tweezers, n_loops, learning_rate=1e-4, epochs=8):
        ...
        self.epochs = epochs
        # Maybe a good idea to have an info attribute that keeps track of that stuff
    ...
    def fidelity_analysis(self, n_tweezers, n_loops, plot=False):
        ...
        labels = np.reshape(np.argmax(self.classify(self.fidelity_crops), axis=1), (self.n_tweezers, self.n_loops, -1))
