...
class AutoGauss():
    ...
    def fwhm(self, x, y):
        ...
        return x[over_half_max[0][1]] - y[over_half_max[0][0]]
    ...
    def fit_gaussians(self):
        ...
        second_guess, first_guess = self.double_gaussians_guess()
        if second_guess[0] == np.inf:
            return first_guess, second_guess
        else:
            params, cov = curve_fit(double_gaussian, self.x_data, self.y_data, p0=[*first_guess, *second_guess])
